"""
Utilities for loading models and visualising LIFT‑CAM outputs.

This module provides helper functions used by the LIFT‑CAM
implementation to load pretrained models (VGG16 or ResNet50),
perform min–max normalisation on explanation maps, preprocess
images for ImageNet models and visualise heatmaps alongside their
corresponding images.

These functions were originally scattered across various scripts
and have been consolidated here for clarity.
"""
